...
import com.example.edgarsc.Utilities.URL_CREATE_USER
import com.example.edgarsc.Utilities.URL_LOGIN
import com.example.edgarsc.Utilities.URL_REGISTER
...
object AuthService {
    ...
    fun loginUser(context: Context, email:String, password:String, complete: (Boolean) -> Unit) {
        ...
        val loginRequest = object : JsonObjectRequest(Method.POST, URL_LOGIN, null, Response.Listener { response ->
            ...
            //This ir where we deal with out error
                error -> Log.d("ERROR", "Could not register user: $error")
            complete(false)
        }) {
            override fun getBodyContentType(): String {
